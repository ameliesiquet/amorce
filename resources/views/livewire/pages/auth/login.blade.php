...
<section class="bg-zinc-900 text-white h-screen flex items-center justify-center">
    ...
    <div class="bg-zinc-900 text-white h-screen flex flex-col items-center justify-center">
        ...
        <form wire:submit.prevent="login"
              class="bg-zinc-900 p-10 border border-amber-200 rounded-2xl text-white flex flex-col gap-4">
            @csrf
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="block mt-2">
                    <label for="remember" class="inline-flex items-center">
                        <input wire:model="form.remember" id="remember" type="checkbox" class="rounded border-gray-300 "
                               name="remember">
