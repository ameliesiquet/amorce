<div class=" sm:max-w-full w-full mx-0 sm:mx-auto">
    <div class="flex flex-col mx-2 sm:mx-2 gap-2 px-8 py-5 bg-white rounded-3xl border border-solid border-black border-opacity-10  2xl:justify-between shadow-[0px_0px_4px_rgba(0,0,0,0.2)] md:px-12 md:py-10  2xl:px-12 ">
        <section class="flex flex-col gap-5 justify-center sm:w-full  sm:mx-auto text-xl font-semibold text-black md:text-lg lg:text-xl">
        ...
        <section class="flex flex-col mt-5 sm:w-full">
            <div class="flex flex-col gap-4 justify-center sm:w-full">
                <h2 class="text-lg font-semibold text-black md:text-base lg:text-lg">Transactions</h2>
