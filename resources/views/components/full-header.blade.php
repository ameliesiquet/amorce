<header class="bg-zinc-900 flex lg:flex-col fixed top-0 left-0 lg:w-64 lg:h-screen shadow-lg z-50">
    ...
    <div class="h-full w-full">
        <div wire:loading class="h-full px-3 py-4 overflow-y-auto space-y-4 bg-zinc-900">
            <div class="h-6 bg-zinc-700 rounded w-3/4"></div>
            <div class="h-6 bg-zinc-700 rounded w-5/6"></div>
            <div class="h-6 bg-zinc-700 rounded w-2/3"></div>
            <div class="h-6 bg-zinc-700 rounded w-4/5"></div>
        </div>
